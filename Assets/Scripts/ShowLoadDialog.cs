...
//Check SDK version > 29
    ...
    FileBrowser.SetFilters(true, new FileBrowser.Filter("3D objects", ".glb",".gltf"), new FileBrowser.Filter("Text Files", ".txt", ".pdf"));
    ...
    FileBrowser.SetExcludedExtensions(".lnk", ".tmp", ".zip", ".rar", ".exe",".png",".jpg",".jpeg",".ico");
...
IEnumerator ShowLoadDialogCoroutine()
{
    ...
    if (FileBrowser.Success)
        ...
        {
            Debug.LogError("Plik gltf nie istnieje: " + FileBrowser.Result[0]);
